...
class ReController extends ApiController
{
    public function saveRE(Request $request)
    {
        ...
        if ($td > 0 || $xd > 0) {
            ...
            // $reMain->DRAFT_NUM = $request->
            // $reMain->DRAFT_IDEN = $request->
            ...
            // $reMain->TS = 
            // $reMain->DESTINATION_FROM = $request->
            // $reMain->DESTINATION_TO = $request->
            // $reMain->ISRELEASED = $request->
            $reMain->PRJID = $request->projectId;
            // $reMain->RELEASEDCASH = $request->
